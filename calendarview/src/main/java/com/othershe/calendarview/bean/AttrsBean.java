...
public class AttrsBean {
    ...
    private int colorLunar = Color.parseColor("#999999");//阴历的日期颜色（几月初几那种）
    private int colorHoliday = Color.parseColor("#EC9729");//节假日的颜色（24节气那种）
    private int colorCustom = Color.parseColor("#ff0000");//风俗
    private int colorChoose = Color.WHITE;//选中的日期文字颜色
    private int sizeSolar = 14;//阳历日期文字尺寸
    private int sizeLunar = 8;//阴历日期文字尺寸
    private int sizeCustoms = 9;//阴历日期文字尺寸
    private int dayBg = R.drawable.blue_circle;//选中的背景
    //    private int dayBg = R.drawable.pzw;//选中的背景
    ...
    public int getSizeCustoms() {
        return sizeCustoms;
    }

    public void setSizeCustoms(int sizeCustoms) {
        this.sizeCustoms = sizeCustoms;
    }
