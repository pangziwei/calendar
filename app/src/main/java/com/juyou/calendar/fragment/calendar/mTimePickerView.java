...
/**
 * @author
 * @datetime 2021-10-11 15:32
 * @detail :
 */
public class mTimePickerView extends MyBasePickerView implements View.OnClickListener {
    private WheelTime wheelTime; //自定义控件
    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";

    private static final String TAG_NONG = "nong";
    private static final String TAG_YING = "ying";
    public TextView tvTitle01;
    public TextView tvTitle02;

    public mTimePickerView(MyPickerOptions mpickerOptions) {
        super(mpickerOptions.context);
        mPickerOptions = mpickerOptions;
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            //顶部标题
//            TextView tvTitle = (TextView) findViewById(R.id.tvTitle);//农历
            tvTitle01 = (TextView) findViewById(R.id.tvTitle02);//阴历
            tvTitle02 = (TextView) findViewById(R.id.tvTitle01);//农历
            ...
            tvTitle02.setTag(TAG_NONG);
            tvTitle01.setTag(TAG_YING);

            btnSubmit.setOnClickListener(this);
            btnCancel.setOnClickListener(this);
            tvTitle02.setOnClickListener(this);
            tvTitle01.setOnClickListener(this);
...
//            }
        ...
        } else if (tag.equals(TAG_NONG)) {
//            Toast.makeText(mPickerOptions.context, "您点击了农历01", Toast.LENGTH_SHORT).show();
            setLunarCalendar(true);
//            此部分可优化
            tvTitle02.setTextColor(mPickerOptions.context.getResources().getColor(R.color.white));
            tvTitle01.setTextColor(mPickerOptions.context.getResources().getColor(R.color.color_F04646));
            tvTitle01.setBackgroundResource(R.drawable.choice_time_title_left_up);
            tvTitle02.setBackgroundResource(R.drawable.choice_time_title_right);
        } else if (tag.equals(TAG_YING)) {
//            Toast.makeText(mPickerOptions.context, "您点击了阴历", Toast.LENGTH_SHORT).show();
            tvTitle02.setTextColor(mPickerOptions.context.getResources().getColor(R.color.color_F04646));
            tvTitle01.setTextColor(mPickerOptions.context.getResources().getColor(R.color.white));
            tvTitle01.setBackgroundResource(R.drawable.choice_time_title_left);
            tvTitle02.setBackgroundResource(R.drawable.choice_time_title_right_up);
