...
public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchAdapter(AddCityActivity activity, List<CityBean> data, String searchText, boolean isSearching) {
        ...
        HeWeather.getGeoCityLookup(activity, cid, Mode.FUZZY, Range.WORLD, 1, lang, new HeWeather.OnResultGeoListener() {
            ...
            public void onSuccess(GeoBean search) {
                ...
                if (search.getStatus().equals(Code.OK.getCode())) {
                    ...
                    Log.e("citys", "citys-----------123------"+new Gson().toJson(basic));
                    ...
                    cityBean.setLat(basicData.getLat());
                    cityBean.setLon(basicData.getLon());
                    ...
                    SpUtils.saveBean(activity, key, cityBeans);
                    DataUtil.setCid(cid);
                    Log.e("citys", "citys-----citys------123------"+new Gson().toJson(citys));
