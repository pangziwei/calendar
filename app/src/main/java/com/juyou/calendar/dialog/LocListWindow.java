...
public class LocListWindow extends PopupWindow {
    ...
    private WeatherActivity weatherActivitycontext;

    public LocListWindow(View contentView, int width, int height, MyMainActivity context) {
        super(contentView, width, height);
        this.view = contentView;
        this.context = context;
    }
    public LocListWindow(View contentView, int width, int height, WeatherActivity weatherActivitycontext) {
        super(contentView, width, height);
        this.view = contentView;
        this.weatherActivitycontext = weatherActivitycontext;
    }
