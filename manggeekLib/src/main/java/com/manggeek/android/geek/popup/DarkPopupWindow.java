 ...
 * @author BakerJ
 */
public class DarkPopupWindow extends PopupWindow {
    ...
    private WeakReference<View> mRightOfPositionView, mLeftOfPositionView, mBelowPositionView, mAbovePositionView, mFillPositionView;
    private boolean mIsDarkInvoked = false;

    public DarkPopupWindow(GeekActivity mActivity) {
        super(mActivity);
    }


    public void setDarkView(View contentView) {
        if (contentView != null) {
