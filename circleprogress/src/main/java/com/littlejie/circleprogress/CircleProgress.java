...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mHintColor = typedArray.getColor(R.styleable.CircleProgressBar_hintColor, 0);
       mArcColors = typedArray.getColor(R.styleable.CircleProgressBar_arcColors, 0);
        ...
        mValueColor = typedArray.getColor(R.styleable.CircleProgressBar_valueColor, 0);
        ...
        mUnitColor = typedArray.getColor(R.styleable.CircleProgressBar_unitColor, 0);
        ...
        mBgArcColor = typedArray.getColor(R.styleable.CircleProgressBar_bgArcColor, 0);
...
//        gradientArcColors = typedArray.getResourceId(R.styleable.CircleProgressBar_arcColors, 0);
